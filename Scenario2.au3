...
WinWaitActive("Java EE - MyHelloWorld2/WebContent/index.jsp - Eclipse")
Sleep(3000)
...
Local $string =  ControlGetText("Java EE - MyHelloWorld2/WebContent/newsession.jsp - Eclipse","","[CLASS:SysLink]")
